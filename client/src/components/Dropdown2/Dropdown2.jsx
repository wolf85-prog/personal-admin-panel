...
const Dropdown2 = ({options, tags, setTags, widthStyle, heightStyle}) => {
    ...
    return (
        <div className={drp.dropdown} ref={wrapperRef}>
            <ul onClick={()=>setMenuShow(!menuShow)} className={`${drp.speclist}`} style={{width: widthStyle, height: heightStyle}}>
                {specList}
            </ul>
