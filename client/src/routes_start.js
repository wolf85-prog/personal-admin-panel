...
const EstimateList = React.lazy(() => import('./views/estimates/EstimateList'))
...
export const authRoutes = [
  ...
  { path: ESTIMATE_LIST_ROUTE, name: 'Сметы', Component: EstimateList },
  { path: ESTIMATE_ROUTE, name: 'Сметы', Component: Estimate },
]
