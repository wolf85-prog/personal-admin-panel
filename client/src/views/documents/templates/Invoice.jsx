...
function Invoice({ template, visible, handleChangeTemplateNumber }) {
    ...
    <>
      ...
      <CCol lg={12}>
        ...
        >
          <div style={{ display: 'flex', gap: '20px' }}>
            <div className="">
              <div className="text-medium-emphasis small text-center">Исполнитель</div>
              {visible ? (
                <input
                ...
                <div style={{ height: '40px', width: '300px' }} className="py-2 uley-data-main">
                  {template.items.invoice_executor.text}
                </div>
              )}
            </div>
          </div>
      ...
      <CCol lg={12}>
        ...
        >
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '20px' }}>
              <div className="">
                <div className="text-medium-emphasis small text-center">Действует на основании</div>
                {visible ? (
                  <input
                    name="invoice_action_basis"
                    style={{ height: '40px', width: '945px' }}
                    className="uley-data-main"
                    placeholder="-"
                  />
                  ...
                  <div style={{ height: '40px', width: '945px' }} className="py-2 uley-data-main">
                    {template.items.invoice_action_basis.text}
                  </div>
                )}
              </div>
            </div>
