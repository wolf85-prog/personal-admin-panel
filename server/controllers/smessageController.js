...
class SmessageController {

    //add message
    async newMessageSupport(req, res) {
    ...
    async getMessagesSupport(req, res) {
    ...
    async getMessagesSupport2(req, res) {
        const conversationId = req.params.id
    ...
    async getAllMessagesSupport(req, res) {
        try {           
            const messages = await Message.findAll({
                order: [
                    ['id', 'ASC'], //DESC ASC
    ...
    async getMessagesSupportCount(req, res) {
    ...
    //delete message
    async delMessageSupport(req, res) {
...
module.exports = new SmessageController()